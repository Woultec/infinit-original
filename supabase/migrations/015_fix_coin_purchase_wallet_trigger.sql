-- Allow place_order / review_coin_topup to update coin_balance (trigger was blocking RPC)
...
AS $$
BEGIN
  -- Set by SECURITY DEFINER RPCs (place_order, review_coin_topup)
...
BEGIN
  ...
  IF p_use_coins THEN
    ...
    PERFORM set_config('wallet.balance_system_update', '1', true);
